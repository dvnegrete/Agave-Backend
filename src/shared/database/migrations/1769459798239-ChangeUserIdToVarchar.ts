...
export class ChangeUserIdToVarchar1769459798239 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        // Si no, ejecutar la migración
        await queryRunner.query(`ALTER TABLE "houses" DROP CONSTRAINT "FK_307de020b40481f780f391df54e"`);
        await queryRunner.query(`ALTER TABLE "houses" ALTER COLUMN "user_id" TYPE character varying USING "user_id"::text`);
        ...
        await queryRunner.query(`ALTER TABLE "manual_validation_approvals" ALTER COLUMN "approved_by_user_id" TYPE character varying USING "approved_by_user_id"::text`);
